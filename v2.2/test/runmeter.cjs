...
(async () => {
  ...
  await t.J(() => { try { localStorage.clear(); localStorage.setItem('kizuna2_2.tutorialSeen','1');
    localStorage.setItem('kizuna2_2.starters', JSON.stringify(['ash','elin','mira','cassia'])); } catch(_){}
    META.deaths = 2;
    window.__notes = 0;
